...
import { ShieldAlert, Star, Inbox, Trash2 } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-gray-500 dark:text-gray-400">
            ...
            <p className="text-sm">Emails identified as spam will appear here</p>
          </div>
        ) : (
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {threads.map((thread) => (
              <SpamThreadItem
                ...
                onNotSpam={() => handleMarkAsNotSpam(thread.id)}
